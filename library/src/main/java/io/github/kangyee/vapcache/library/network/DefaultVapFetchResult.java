...
public class DefaultVapFetchResult implements VapFetchResult {

    @NonNull
    private final HttpURLConnection connection;

    public DefaultVapFetchResult(@NonNull HttpURLConnection connection) {
    ...
    @Nullable @Override public String error() {
        try {
            ...
            Logger.INSTANCE.warning("get error failed ", e);
            return e.getMessage();
        }
    }
